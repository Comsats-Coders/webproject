    ...
    <nav class="navbar navbar-expand-lg navbar-light mb-3" id="nav">
                    ...
                    <div class="px-4 pt-0 pb-4 cover">
                        <div class="media align-items-end profile-head">
                            <div class="profile mr-3"><img src="/{{$pd->profilePic}}" alt="Cover Pic" 
                                 class="rounded-circle mb-2" id="Ppic"><a href="#" class="btn btn-block">Follow</a></div>
     ...
     <div class="card-body mb-4 pt-5 pr-4 pl-4" id="what">
        <div class="card-title">
            <form action="/addQuestion/{{$pd->userID}}" method="post" id="form">
            @csrf
              <textarea name="qs" id="post" cols="" rows="2" placeholder="Ask a question?" form="form"></textarea>
       <span><a href="javascript:$('form').submit();" class="btn btn-info disabled float-right" role="button" id="askBtn">Poocho</a> </span> </div>
        </div>
        </form>
        @endforeach 
         ...
         @foreach($questionPosts as $qp)
                    <div class="card-body bg-white rounded m-4" id="qa">
                        ...
                        <hr>
                        <div class="card-text">
                            <img class="rounded-circle" width="45" src="/{{$qp->profilePic}}" alt="">
